...
import { ApiTags, ApiOperation, ApiResponse, ApiConsumes, ApiBody, ApiQuery, ApiBearerAuth, ApiParam } from '@nestjs/swagger';




@ApiTags('features')
@Controller('features')export class FeaturesController {
  featureModel: any;
...
@ApiParam({ name: 'id', type: 'string', required: true, description: 'Feature ID' })
